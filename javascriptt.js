function toggleButton() {
    ...
    button__nombrar.disabled = textoInput.trim() === "" || !isValid;
...
function toggleButtonCrear() {
    ...
    //habilitar el botón si el nombre es válido y si hay un input radio seleccionado
    buttonNombrar__crear.disabled = textoInput.trim() === "" || !isValid || !radioChecked;
